...
export default function NewPetitionPage() {
  ...
  const onSubmit: SubmitHandler<PetitionFormInputs> = async (data) => {
    ...
    toast({
      ...
      description: `Your petition "${newPetition.title}" has been saved as a draft.`,
    });
    router.push('/dashboard'); // Or to the petition details page: `/petitions/${newPetition.id}`
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Button type="button" variant="outline" size="sm" onClick={handleAiCategorize} disabled={isCategorizing || !petitionTitle || petitionDescription.length < 20}>
